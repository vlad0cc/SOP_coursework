...
public class RabbitMQConfig {
     ...
     * - "document.created"  → попадёт в очередь с binding key "document.*"
     * - "employee.deleted" → попадёт в очередь с binding key "#" (все события)
     *
     ...
     * - q.audit.documents с "document.*" — только события документов,
     * - q.notification.employees с "employee.created" — уведомления при создании сотрудника.
     */
    @Bean
