package edu.rutmiit.demo.documentrest.exception;

import edu.rutmiit.demo.documentsapicontract.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleDocumentNumberConflict(DocumentNumberAlreadyExistsException ex,
                                                            HttpServletRequest req) {
        return ResponseEntity
                .status(HttpStatus.CONFLICT)
                .body(new ErrorResponse(
                        HttpStatus.CONFLICT.value(),
                        BASE_PROBLEM_URI + "document-number-conflict",
                        "Конфликт номера документа",
                        ex.getMessage(),
                        req.getRequestURI(),
                        Instant.now(),
                        null
    ...
    public ResponseEntity<ErrorResponse> handleResponseStatus(ResponseStatusException ex,
        ...
        return ResponseEntity
                ...
                .body(new ErrorResponse(
                        status.value(),
                        BASE_PROBLEM_URI + "request-error",
