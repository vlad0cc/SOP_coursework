package edu.rutmiit.demo.documentrest.graphql.exception;
...
public class GraphQLExceptionHandler implements DataFetcherExceptionHandler {
    ...
    public CompletableFuture<DataFetcherExceptionHandlerResult> handleException(
        ...
        // Конфликт номера документа — аналог HTTP 409
        if (exception instanceof DocumentNumberAlreadyExistsException) {
