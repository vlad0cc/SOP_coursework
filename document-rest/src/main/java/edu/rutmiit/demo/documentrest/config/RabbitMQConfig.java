package edu.rutmiit.demo.documentrest.config;
...
/**
 * Конфигурация RabbitMQ на стороне publisher'а (document-rest).
 *
...
public class RabbitMQConfig {
    ...
    public static final String DOCUMENT_AUDITED_QUEUE = "q.document-rest.document-audited";
    ...
    @Bean
    public Queue documentAuditedQueue() {
        return QueueBuilder.durable(DOCUMENT_AUDITED_QUEUE).build();
    }

    @Bean
    public Binding documentAuditedBinding(Queue documentAuditedQueue, TopicExchange eventsExchange) {
        return BindingBuilder
                .bind(documentAuditedQueue)
                .to(eventsExchange)
                .with(RoutingKeys.DOCUMENT_AUDITED);
    }
}
