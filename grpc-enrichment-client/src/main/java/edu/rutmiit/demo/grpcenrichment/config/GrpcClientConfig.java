 ...
 * - Для async используется DocumentAnalyticsGrpc.newFutureStub() или newStub()
 *
...
public class GrpcClientConfig {
    ...
    /**
     * BlockingStub — синхронный клиент для вызова DocumentAnalytics.AnalyzeDocument().
     *
     ...
     */
    @Bean
    public DocumentAnalyticsGrpc.DocumentAnalyticsBlockingStub documentAnalyticsStub(ManagedChannel channel) {
        return DocumentAnalyticsGrpc.newBlockingStub(channel);
    }
